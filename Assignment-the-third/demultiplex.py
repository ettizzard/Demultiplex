...
index_hopped_filenames = {}
lowqual_unknown_filenames = {}


#Initializing filename and pair count dictionaries for indices.
dualmatched_filename_dict = {} # {keys: (index1, index2); values: (R1_dualmatched_{index1}-{index2}.fq, R2_dualmatched_{index1}-{index2}.fq)}
...
#print(dual_matched_pairs_count)
#print(dualmatched_filename_dict)
...
#        print(r1_header, r1_sequence, r1_plus, r1_qscore)
        if r1_header == "":
            break
        ...
        # print(indexed_r1_header)
        # print(indexed_r4_header)
        

        #First if statement to sort out unknown/low quality record
        ...
        if r2_sequence in indices and r3_sequence_rc in indices:
            ...
            #Sorting known reads of low quality. If any index base is lower than 32, we're throwing the entire record into the low quality bin.
            #We don't really care about biological read quality, as our downstream analysis will sort the low quality data.
